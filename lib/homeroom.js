...
/*!
  ...
  homeroom
  the only fucking class that I ever went to
  NodeJS OO Class System
  https://github.com/edwardhotchkiss/homeroom/

 */

var homeroom = module.exports =  function(namespace) {
  this.__constructor = function(fn) {
    fn.apply(this, this.arguments);
  };
  this.__destructor = function(fn) {
    fn.apply(this, this.arguments);
  }
};
      ...
      load : function( codePath, first ) {
        try {
          ...
          if (request.status == 200 ) {
            ...
            window[ codeName ]._script = request.responseText
            _.definition.queue.push(codeName);
